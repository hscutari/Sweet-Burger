...
public class MeatTest {
    ...
    public void teste() {
        ...
        onView(withRecyclerView(R.id.recycler_view)
                .atPositionOnView(0, R.id.tieQuantity))
                .perform(replaceText("1"));

        SystemClock.sleep(1000);
        onView(withRecyclerView(R.id.recycler_view)
                .atPositionOnView(1, R.id.tieQuantity))
        ...
        SystemClock.sleep(1000);
        onView(withId(R.id.recycler_view)).check(matches(atPosition(0, hasDescendant(withText("R$8.78")))));
    }
